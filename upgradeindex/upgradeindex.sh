...
JAR_CORE_6=lucene-core-6.2.0.jar
JAR_CORE_6_URL=http://central.maven.org/maven2/org/apache/lucene/lucene-core/6.2.0/lucene-core-6.2.0.jar
JAR_BACK_6=lucene-backward-codecs-6.2.0.jar
JAR_BACK_6_URL=http://central.maven.org/maven2/org/apache/lucene/lucene-backward-codecs/6.2.0/lucene-backward-codecs-6.2.0.jar
BASEDIR=$(dirname "$0")
BACKUP=true
TARGET=6
